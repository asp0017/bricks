          ...
          return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.div, {
            ...
            onClick: e => {
              navigator.clipboard.writeText(`Color["${name}"]`).then(() => {
                ...
                popupBox.style.top = e.clientY + window.scrollY + "px";
                popupBox.style.left = e.clientX + window.scrollX + "px";
                // Hide popup box after 2 seconds
                setTimeout(() => {
...
//# sourceMappingURL=stories-general-Color-mdx.0648195cd47f55bf2f4c.hot-update.js.map