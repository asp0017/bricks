          ...
          return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.div, {
            ...
            onClick: e => {
              navigator.clipboard.writeText(`Color["${name}"]`).then(() => {
                ...
                popupBox.style.top = e.clientY + 10 + "px";
                popupBox.style.left = e.clientX + 10 + "px";
                // Hide popup box after 2 seconds
                setTimeout(() => {
...
//# sourceMappingURL=stories-general-Color-mdx.c1e1c30679a442309bdb.hot-update.js.map