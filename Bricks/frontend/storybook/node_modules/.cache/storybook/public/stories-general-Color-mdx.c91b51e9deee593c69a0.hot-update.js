...
function MDXContent(props = {}) {
  ...
  .my-item {
    ...
    border-radius: 5px;
    transition: background 1s ease-out, border 150ms ease-out, transform 150ms ease-out;
    background: #ffffff;
    display: flex;
...
//# sourceMappingURL=stories-general-Color-mdx.c91b51e9deee593c69a0.hot-update.js.map