...
function MDXContent(props = {}) {
  ...
  `
        ...
        children: _components_Color_json__WEBPACK_IMPORTED_MODULE_2__.grey_scale.map(name => {
          // compute the greyscale value of Color[name]
          const grey = _components_Color_json__WEBPACK_IMPORTED_MODULE_2__[name].slice(1, 3) * 0.299 + _components_Color_json__WEBPACK_IMPORTED_MODULE_2__[name].slice(3, 5) * 0.587 + _components_Color_json__WEBPACK_IMPORTED_MODULE_2__[name].slice(5, 7) * 0.114;
          // if the greyscale value is less than 128, use white text, otherwise use black text
...
//# sourceMappingURL=stories-general-Color-mdx.2f8320702b8068f3d17f.hot-update.js.map