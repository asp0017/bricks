...
// if the greyscale value is less than 128, use white text, otherwise use black text
// Generate a block with a square with background: Color[name], and text: name
// Color[name] is the hex code of the color
// Copy the hex code to clipboard when the block is clicked
...
function MDXContent(props = {}) {
  ...
  `
        ...
        children: ["在你的 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
          children: ".js"
        }), " 檔案中，你可以透過 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        ...
        children: _components_Color_json__WEBPACK_IMPORTED_MODULE_2__.grey_scale.map(name => {
          ...
          return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.div, {
            className: "my-item",
            onClick: e => {
              navigator.clipboard.writeText(_components_Color_json__WEBPACK_IMPORTED_MODULE_2__[name]);
            },
            onMouseOver: e => {
              e.currentTarget.style.backgroundColor = _components_Color_json__WEBPACK_IMPORTED_MODULE_2__[name];
            },
...
//# sourceMappingURL=stories-general-Color-mdx.dbb7d31b41376c42fa25.hot-update.js.map