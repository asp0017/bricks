...
function MDXContent(props = {}) {
  ...
  #popup-box {
    ...
    position: absolute;
    padding: 3px;
    background-color: ${_components_Color_json__WEBPACK_IMPORTED_MODULE_2__["bricks red"]};
    color: #fff;
    font-size: 14px;
    border-radius: 5px;
    z-index: 999;
...
//# sourceMappingURL=stories-general-Color-mdx.6e0490128774641eba4f.hot-update.js.map