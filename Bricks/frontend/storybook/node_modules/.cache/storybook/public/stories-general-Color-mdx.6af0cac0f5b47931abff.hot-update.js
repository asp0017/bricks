...
function MDXContent(props = {}) {
  ...
  .my-item {
    ...
    border-radius: 5px;
    transition: background 1s, border 150ms ease-out, transform 150ms ease-out;
    background: #ffffff;
    display: flex;
...
//# sourceMappingURL=stories-general-Color-mdx.6af0cac0f5b47931abff.hot-update.js.map