          ...
          return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.div, {
            ...
            onClick: e => {
              navigator.clipboard.writeText(`Color["${name}"]`).then(() => {
                ...
                popupBox.style.top = event.clientY + 10 + "px";
                popupBox.style.left = event.clientX + 10 + "px";
                // Hide popup box after 2 seconds
                setTimeout(() => {
...
//# sourceMappingURL=stories-general-Color-mdx.b8ee776429f17c43a4fd.hot-update.js.map