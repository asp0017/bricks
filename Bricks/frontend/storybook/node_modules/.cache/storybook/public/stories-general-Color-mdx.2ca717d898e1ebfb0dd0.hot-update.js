...
// Alert when the copy is successful
// Repeat generatnig a block for each color in the grey_scale array
// compute the greyscale value of Color[name]
// if the greyscale value is less than 128, use white text, otherwise use black text
// Generate a block with a square with background: Color[name], and text: name
...
function MDXContent(props = {}) {
  ...
  .my-item:hover:not(:active) {
    border-color: 0.5px solid ${_components_Color_json__WEBPACK_IMPORTED_MODULE_2__["bricks red"]};
    transform: translate3d(0, -3px, 0);
    box-shadow: rgba(0, 0, 0, 0.08) 0 3px 10px 0;
  }

  .my-item:active {
    border-color: 1px solid ${_components_Color_json__WEBPACK_IMPORTED_MODULE_2__["bricks red"]};
...
//# sourceMappingURL=stories-general-Color-mdx.2ca717d898e1ebfb0dd0.hot-update.js.map