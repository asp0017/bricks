...
在你的 `.js` 檔案中，你可以引入 `import { Color } from '../../components/Color';`<img id="copy" src={copyicon} alt="" 
onClick={(e) => { navigator.clipboard.writeText(`import { Color } from '../../components/Color';`)
